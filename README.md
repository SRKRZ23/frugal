...
frugal diagnose your_log.jsonl --live --backend ollama --host http://localhost:11434 \
        --cheap qwen2.5:7b --frontier phi4:14b   # MEASURE it: really route each prompt, observe cost+latency+escalation
